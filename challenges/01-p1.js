function solution(input) {
    // divide the calibration document into individual lines
    const lines = input.split('\n');

    let sum = 0;

    // iterate over each line to calculate the calibration value
    lines.forEach(line => {
        // search for the first and last digit in the line
